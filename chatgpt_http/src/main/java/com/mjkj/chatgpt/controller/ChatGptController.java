...
public class ChatGptController {
    ...
    public ResultModel getContent(@RequestBody ChatGptParam gptModel) {
        try {
...
//            ChatGptParam gptModel = JSONObject.parseObject(paramStr, ChatGptParam.class);
    ...
    public ResultModel getChatGptContent(@RequestBody ChatGptPublicParam param) {
        try {
//            if (StrUtil.isEmpty(paramStr)) {
//                return this.getErrorModel("参数为空2");
//            }
...
//            ChatGptPublicParam param = JSONObject.parseObject(jsonStr, ChatGptPublicParam.class);
    ...
    public static void main(String[] args) {
        AES aes = SecureUtil.aes(aesKey.getBytes());
        String s = aes.encryptHex("{\"model\": \"gpt-3.5-turbo\",\"messages\": [{\"role\": \"user\", \"content\": \"Say this is a test!\"}],\"temperature\": 0.7}");
